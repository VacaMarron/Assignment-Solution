...
//Tried to implement the same method than in the examples, creating the menu class and everything
//	but, for some reason i didn't manage to figure out, it didn't work, when the program had
//	to use the write() function from Customer it simply didn't work.
//I had to ask for help to a couple of classmates and they told me to try this way, using the 
//	JTextField panel for the Main Menu too instead that only for the read() and edit() funtions.
